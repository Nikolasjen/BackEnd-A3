...
namespace FoodAppG4.Migrations
{
    ...
    [Migration("20241027183053_CustomErrorDishPriceMigration")]
    partial class CustomErrorDishPriceMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FoodAppG4.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OrderId = 1,
                            CustomerId = 1,
                            OrderDate = new DateTime(2024, 10, 27, 19, 30, 52, 823, DateTimeKind.Local).AddTicks(3928)
                        });
                });
