...
namespace FoodAppG4.Migrations
{
    ...
    [Migration("20241027151254_SeedDataForAllEntities")]
    partial class SeedDataForAllEntities
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FoodAppG4.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OrderId = 1,
                            CustomerId = 1,
                            OrderDate = new DateTime(2024, 10, 27, 16, 12, 54, 519, DateTimeKind.Local).AddTicks(2292)
                        });
                });
