...
namespace FoodAppG4.Migrations
{
    ...
    [Migration("20241126144356_UserLogging")]
            ...
            modelBuilder.Entity("FoodAppG4.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OrderId = 1,
                            CustomerId = 1,
                            OrderDate = new DateTime(2024, 11, 26, 15, 43, 55, 961, DateTimeKind.Local).AddTicks(7381)
                        },
                        new
                        {
                            OrderId = 2,
                            CustomerId = 2,
                            OrderDate = new DateTime(2024, 11, 26, 15, 43, 55, 961, DateTimeKind.Local).AddTicks(7426)
                        });
                });
